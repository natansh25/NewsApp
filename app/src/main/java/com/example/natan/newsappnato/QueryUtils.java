    ...
    private static List<Earthquake> extractFeatureFromJson(String earthquakeJSON) {
        ...
        try {
            ...
            for (int i = 0; i < earthquakeArray.length(); i++) {
                ...
                //String author=currentEarthquake.getJSONObject("").getString("author");


                // Extract the value for the key called "place"
                String title = currentEarthquake.getString("title");

                String des = currentEarthquake.getString("description");


                String url_to_image=currentEarthquake.getString("urlToImage");

                // Create a new {@link Earthquake} object with the magnitude, location, time,
                // and url from the JSON response.
                Earthquake earthquake = new Earthquake(title, des,url_to_image);
